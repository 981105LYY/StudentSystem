...
<body>
	...
	<table border='0' cellpadding='5' cellspacing='0' align='center'>
		...
		<tr>
			...
			<td>fa-search-plus</td>
			<td><i class='fa fa-search-minus'></i></td>
			<td>fa-search-minus</td>
		...
		<tr>
			...
			<td>fa-arrow-circle-o-down</td>
			<td><i class='fa fa-arrow-circle-o-up'></i></td>
			<td>fa-arrow-circle-o-up</td>
			<td><i class='fa fa-inbox'></i></td>
			<td>fa-inbox</td>
			<td><i class='fa fa-play-circle-o'></i></td>
			<td>fa-play-circle-o</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>fa-font</td>
			<td><i class='fa fa-bold'></i></td>
			<td>fa-bold</td>
			<td><i class='fa fa-italic'></i></td>
			<td>fa-italic</td>
			<td><i class='fa fa-text-height'></i></td>
			<td>fa-text-height</td>
			<td><i class='fa fa-text-width'></i></td>
			<td>fa-text-width</td>
			<td><i class='fa fa-align-left'></i></td>
			<td>fa-align-left</td>
		</tr>
		<tr>
			<td><i class='fa fa-align-center'></i></td>
			<td>fa-align-center</td>
			<td><i class='fa fa-align-right'></i></td>
			<td>fa-align-right</td>
			<td><i class='fa fa-align-justify'></i></td>
			<td>fa-align-justify</td>
			<td><i class='fa fa-list'></i></td>
			<td>fa-list</td>
			<td><i class='fa fa-dedent'></i></td>
			<td>fa-dedent</td>
			<td><i class='fa fa-outdent'></i></td>
			<td>fa-outdent</td>
			<td><i class='fa fa-indent'></i></td>
			<td>fa-indent</td>
			<td><i class='fa fa-video-camera'></i></td>
			<td>fa-video-camera</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>fa-times-circle-o</td>
		</tr>
		<tr>
			<td><i class='fa fa-check-circle-o'></i></td>
			<td>fa-check-circle-o</td>
		...
		<tr>
			...
			<td>fa-expand</td>
			<td><i class='fa fa-compress'></i></td>
			<td>fa-compress</td>
		...
		<tr>
			...
			<td>fa-twitter-square</td>
			<td><i class='fa fa-facebook-square'></i></td>
			<td>fa-facebook-square</td>
		...
		<tr>
			...
			<td>fa-thumbs-o-up</td>
			<td><i class='fa fa-thumbs-o-down'></i></td>
			<td>fa-thumbs-o-down</td>
		...
		<tr>
			...
			<td>fa-hand-o-right</td>
			<td><i class='fa fa-hand-o-left'></i></td>
			<td>fa-hand-o-left</td>
		</tr>
		<tr>
			<td><i class='fa fa-hand-o-up'></i></td>
			<td>fa-hand-o-up</td>
			<td><i class='fa fa-hand-o-down'></i></td>
			<td>fa-hand-o-down</td>
			<td><i class='fa fa-arrow-circle-left'></i></td>
			<td>fa-arrow-circle-left</td>
			<td><i class='fa fa-arrow-circle-right'></i></td>
			<td>fa-arrow-circle-right</td>
			<td><i class='fa fa-arrow-circle-up'></i></td>
			<td>fa-arrow-circle-up</td>
			<td><i class='fa fa-arrow-circle-down'></i></td>
			<td>fa-arrow-circle-down</td>
		...
		<tr>
			<td><i class='fa fa-floppy-o'></i></td>
			<td>fa-floppy-o</td>
			...
			<td>fa-bars</td>
			<td><i class='fa fa-list-ul'></i></td>
			<td>fa-list-ul</td>
			<td><i class='fa fa-list-ol'></i></td>
			<td>fa-list-ol</td>
			<td><i class='fa fa-strikethrough'></i></td>
			<td>fa-strikethrough</td>
		</tr>
		<tr>
			<td><i class='fa fa-underline'></i></td>
			<td>fa-underline</td>
			...
			<td>fa-pinterest-square</td>
			<td><i class='fa fa-google-plus-square'></i></td>
			<td>fa-google-plus-square</td>
		...
		<tr>
			...
			<td>fa-caret-up</td>
			<td><i class='fa fa-caret-left'></i></td>
			<td>fa-caret-left</td>
		...
		<tr>
			...
			<td>fa-fighter-jet</td>
			<td><i class='fa fa-beer'></i></td>
			<td>fa-beer</td>
			<td><i class='fa fa-h-square'></i></td>
			<td>fa-h-square</td>
		...
		<tr>
			...
			<td>fa-angle-double-up</td>
			<td><i class='fa fa-angle-double-down'></i></td>
			<td>fa-angle-double-down</td>
		...
		<tr>
			...
			<td>fa-code-fork</td>
			<td><i class='fa fa-unlink'></i></td>
			<td>fa-unlink</td>
		</tr>
		<tr>
			<td><i class='fa fa-chain-broken'></i></td>
			<td>fa-chain-broken</td>
		...
		<tr>
			...
			<td>fa-maxcdn</td>
			<td><i class='fa fa-chevron-circle-left'></i></td>
			<td>fa-chevron-circle-left</td>
		</tr>
		<tr>
			<td><i class='fa fa-chevron-circle-right'></i></td>
			<td>fa-chevron-circle-right</td>
			<td><i class='fa fa-chevron-circle-up'></i></td>
			<td>fa-chevron-circle-up</td>
			<td><i class='fa fa-chevron-circle-down'></i></td>
		...
		<tr>
			...
			<td>fa-inr</td>
			<td><i class='fa fa-cny'></i></td>
			<td>fa-cny</td>
			<td><i class='fa fa-rmb'></i></td>
			<td>fa-rmb</td>
			<td><i class='fa fa-yen'></i></td>
			<td>fa-yen</td>
			<td><i class='fa fa-jpy'></i></td>
			<td>fa-jpy</td>
			<td><i class='fa fa-ruble'></i></td>
			<td>fa-ruble</td>
		</tr>
		<tr>
			<td><i class='fa fa-rouble'></i></td>
			<td>fa-rouble</td>
			<td><i class='fa fa-rub'></i></td>
			<td>fa-rub</td>
			<td><i class='fa fa-won'></i></td>
			<td>fa-won</td>
			<td><i class='fa fa-krw'></i></td>
			<td>fa-krw</td>
		...
		<tr>
			...
			<td>fa-file-word-o</td>
			<td><i class='fa fa-file-excel-o'></i></td>
			<td>fa-file-excel-o</td>
			<td><i class='fa fa-file-powerpoint-o'></i></td>
			<td>fa-file-powerpoint-o</td>
		</tr>
		<tr>
			<td><i class='fa fa-file-photo-o'></i></td>
			<td>fa-file-photo-o</td>
			<td><i class='fa fa-file-picture-o'></i></td>
			<td>fa-file-picture-o</td>
			<td><i class='fa fa-file-image-o'></i></td>
			<td>fa-file-image-o</td>
			<td><i class='fa fa-file-zip-o'></i></td>
			<td>fa-file-zip-o</td>
			<td><i class='fa fa-file-archive-o'></i></td>
			<td>fa-file-archive-o</td>
			<td><i class='fa fa-file-sound-o'></i></td>
			<td>fa-file-sound-o</td>
			<td><i class='fa fa-file-audio-o'></i></td>
			<td>fa-file-audio-o</td>
			<td><i class='fa fa-file-movie-o'></i></td>
			<td>fa-file-movie-o</td>
		</tr>
		<tr>
			<td><i class='fa fa-file-video-o'></i></td>
			<td>fa-file-video-o</td>
			<td><i class='fa fa-file-code-o'></i></td>
			<td>fa-file-code-o</td>
			...
			<td>fa-life-buoy</td>
			<td><i class='fa fa-life-saver'></i></td>
			<td>fa-life-saver</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>fa-bell-slash</td>
			<td><i class='fa fa-bell-slash-o'></i></td>
			<td>fa-bell-slash-o</td>
		...
		<tr>
			...
			<td>fa-at</td>
			<td><i class='fa fa-eyedropper'></i></td>
			<td>fa-eyedropper</td>
			<td><i class='fa fa-paint-brush'></i></td>
			<td>fa-paint-brush</td>
			<td><i class='fa fa-birthday-cake'></i></td>
			<td>fa-birthday-cake</td>
		...
		<tr>
			...
			<td>fa-cc</td>
			<td><i class='fa fa-shekel'></i></td>
			<td>fa-shekel</td>
			<td><i class='fa fa-sheqel'></i></td>
			<td>fa-sheqel</td>
			<td><i class='fa fa-ils'></i></td>
			<td>fa-ils</td>
